...
<div className='sm:shadow-xl p-[10px] md: p-[20px] bg-[#e3e3e8] ml-[50px]  w-[300px] flex-col mb-[40px] items-center rounded-[30PX] h-[500px] text-center shadow-xl shadow-black/50 lg:w-[400px]'>
   <a href={profileimg}> <img src={profileimg} alt="" width={200} className='sm:mb-[10px] lg:ml-[100px] mt-[10px] rounded-[100px] md:h-[230px]  ml-[53px]' /></a>
...
I am a student of Mountain Top University Ibafo Ogun State <br />
    ...
    multiple project which are available in <Link to='/blog' className='border-b-[2px]'>Blog</Link>
    </p>
