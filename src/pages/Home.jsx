...
<div className='sm:shadow-xl p-[20px] md: bg-[#e3e3e8] ml-[50px]  w-[300px] flex-col mb-[40px] items-center rounded-[30PX] h-[500px] text-center shadow-xl shadow-black/50 lg:w-[400px]'>
